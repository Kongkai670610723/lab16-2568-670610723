//D:\workspace\lab16-2568-670610723\src\middlewares\checkRoleStudentMiddleware.ts
...
export const checkRoleStudent = (                                               //เปลี่ยนจาก checkRoleAdmin เป็น checkRoleStudent
  req: CustomRequest,
  res: Response,
  next: NextFunction
) => {
  ...
  if (!user || user.role !== "STUDENT") {                                       //เปลี่ยนจาก Admin เป็น Student
